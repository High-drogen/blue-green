...
## new project and blue app from master
    ...
    oc new-app https://github.com/High-drogen/blue-green.git#master --name=blue --strategy=sti
...
## green app deploy
    ...
    oc new-app https://github.com/High-drogen/blue-green.git#green --name=green
